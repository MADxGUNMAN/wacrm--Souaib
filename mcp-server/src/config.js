...
export function loadConfig() {
    var _a, _b;
    const baseUrlRaw = (_a = process.env.WACRM_BASE_URL) === null || _a === void 0 ? void 0 : _a.trim();
    const apiKey = (_b = process.env.WACRM_API_KEY) === null || _b === void 0 ? void 0 : _b.trim();
    const missing = [];
    if (!baseUrlRaw)
        missing.push('WACRM_BASE_URL');
    if (!apiKey)
        missing.push('WACRM_API_KEY');
    if (missing.length > 0) {
