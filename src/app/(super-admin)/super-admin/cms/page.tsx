...
const cmsModules = [
  ...
  },
  {
    ...
    description:
      'Build the /docs page: grouped guides, feature links and badges.',
    icon: BookOpen,
        ...
        {cmsModules.map((module) => {
          ...
          return (
            <Link key={module.href} href={module.href} className="group block">
              <div
                className={`h-full rounded-xl border bg-white p-6 transition-all duration-200 hover:-translate-y-1 hover:bg-slate-50 hover:shadow-md ${module.borderColor}`}
              >
