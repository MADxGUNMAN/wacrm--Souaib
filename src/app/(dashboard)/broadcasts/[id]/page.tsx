    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        {/* Delete — inline-confirm pattern matches the pipeline-settings
            ...
            funnel inconsistent. */}
        {confirmDelete ? (
          <div className="flex items-center gap-2 rounded-md border border-red-200 bg-red-500/10 px-3 py-1.5 text-sm">
          ...
          <Button
            ...
            className="border-red-200 bg-transparent text-red-600 hover:bg-red-500/10 disabled:opacity-40"
          >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="border-border bg-card">
                <DropdownMenuItem
                  ...
                  className={
                    statusFilter === 'all' ? 'text-violet-600' : 'text-muted-foreground'
                  }
                >
                  All statuses
                </DropdownMenuItem>
