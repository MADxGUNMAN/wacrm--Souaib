...
const context = {
  ...
  accountId: 'account-1',
  userId: 'user-1',
  // Migration 038 collapsed admin/agent/viewer into `member`, and the
  // route was updated to require `member`. This fixture still said
  // `agent`.
  role: 'member',
