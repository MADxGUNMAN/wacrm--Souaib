...
export function MembersTab() {
  ...
  const [editingPermissionsMember, setEditingPermissionsMember] =
                  ...
                  <div className="flex min-w-0 flex-1 items-center gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {!member.is_active && (
                          <Badge className="border-red-500/20 bg-red-500/10 text-[10px] tracking-wide text-red-500 uppercase">
                            {t('suspendedBadge')}
                          </Badge>
                        )}
                      </div>
                        ...
                        <div className="mt-1.5 flex flex-wrap gap-1">
                          {Object.entries(member.permissions)
                            ...
                            .map(([key]) => (
                              <span
                                key={key}
                                className="bg-primary/10 text-primary border-primary/20 inline-flex items-center rounded border px-1.5 py-0.5 text-[10px] font-medium capitalize"
                              >
                                {key}
                              </span>
                            ))}
                  ...
                  <div className="flex items-center gap-2 sm:gap-3">
                    {canManageMembers && !isOwnerRow && (
                      <Button
                        ...
                        className="border-border text-muted-foreground hover:text-foreground hover:bg-muted h-8 px-2"
                      >
