        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-5">
            <Avatar size="lg" className="size-16">
              ...
              <AvatarFallback className="bg-violet-500/10 text-base text-violet-600">
                {initial}
              </AvatarFallback>
            </Avatar>
          ...
          <div className="space-y-2">
            <Label htmlFor="profile-full-name" className="text-card-foreground">
              Display name
            </Label>
            <Input
          ...
          <div className="space-y-2">
            ...
            />
            {emailChangePending && (
              <p className="flex items-start gap-2 rounded-md border border-amber-200 bg-amber-500/5 px-3 py-2 text-xs text-amber-700">
          ...
          <div className="rounded-lg border border-border bg-muted p-4">
            ...
            <dl className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2">
              ...
              <div>
                ...
                <dd className="mt-0.5 text-card-foreground">{joined}</dd>
              </div>
