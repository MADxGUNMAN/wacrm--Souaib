...
//
// Two-step modal:
//   1. Form  — expiry + optional label → POST creates the invite.
//      Role is always 'member' (simplified system).
              ...
              <div className="space-y-2">
                <div className="rounded-md border border-border bg-muted/30 px-3 py-2">
                  <p className="text-xs text-muted-foreground">
                    This invite link will add the recipient as a <strong className="text-foreground">Member</strong> of your workspace. You can configure their specific permissions after they join.
                  </p>
                </div>
              </div>
