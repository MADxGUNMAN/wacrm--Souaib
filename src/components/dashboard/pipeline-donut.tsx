  ...
  return (
    <div className="flex items-center justify-center select-none">
      <svg
        ...
        className="h-48 w-48 outline-none select-none focus:outline-none"
        role="img"
      ...
      >
        ...
        <text
          ...
          y={cy - 6}
          textAnchor="middle"
          className="fill-muted-foreground pointer-events-none text-[11px] select-none"
        >
          {t('total')}
        </text>
        <text
          ...
          y={cy + 14}
          textAnchor="middle"
          className="fill-foreground pointer-events-none text-[18px] font-semibold tabular-nums select-none"
        >
