      ...
      <DialogContent className="bg-card border-border text-card-foreground sm:max-w-lg">
        ...
        <div className="space-y-4">
          ...
          <div
            ...
            className="flex flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-border p-6 cursor-pointer hover:border-violet-500/50 transition-colors"
          >
            {file ? (
              <>
          ...
          {result && (
            <div className="rounded-lg border border-border p-4 space-y-2">
              ...
              <div className="flex items-center gap-4">
                {result.imported > 0 && (
                  <div className="flex items-center gap-1.5 text-violet-600 text-sm">
