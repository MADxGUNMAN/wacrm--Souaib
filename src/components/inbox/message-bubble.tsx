...
function MediaImage({ url, alt }: { url: string; alt: string }) {
  ...
  return (
    <Dialog>
      <DialogTrigger className="p-0 border-none bg-transparent m-0 focus:outline-none">
        <img
          src={src ?? ""}
          alt={alt}
      ...
      <DialogContent className="max-w-4xl bg-transparent border-none shadow-none p-0 flex justify-center [&>button]:text-white">
        <img
          src={src ?? ""}
          alt={alt}
