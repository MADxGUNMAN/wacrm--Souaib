      ...
      <div className="space-y-2 border-b border-border p-3">
        <div className="relative">
          ...
          <Input
            ...
            className="border-border bg-muted pl-9 text-sm text-foreground placeholder-slate-500 focus:border-violet-500/50"
          />
        </div>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive && "border-l-2 border-violet-500 bg-muted/70"
      )}
    >
      {/* Avatar */}
