  ...
  (props, forwardedRef) => {
    ...
    return (
      <div
        ref={forwardedRef}
        className={cx(
          'h-80 w-full select-none focus:outline-none focus-visible:outline-none [&_.recharts-responsive-container]:outline-none [&_.recharts-surface]:outline-none [&_.recharts-wrapper]:outline-none [&_svg]:outline-none [&_text]:select-none',
          className
        )}
        ...
        <ResponsiveContainer>
          ...
          >
            ...
            <XAxis
              ...
              stroke=""
              className={cx(
                'fill-muted-foreground pointer-events-none text-xs select-none',
