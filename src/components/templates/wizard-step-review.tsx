    ...
    <div className="space-y-5">
          ...
          {isAuth ? (
            <>
              ...
              <Row
                ...
                value={
                  draft.auth.addSecurityRecommendation ? 'Included' : 'Omitted'
                }
              />
              <Row
                label="Code expiry"
      ...
      <section className="space-y-3">
        ...
        <div className="border-border bg-muted/40 flex items-start gap-3 rounded-lg border p-3">
          ...
          <p className="text-muted-foreground text-sm">
            Review usually takes minutes but can take up to 24 hours. You cannot
            send with this template until it is approved — the status updates
            here automatically.
          </p>
        </div>
