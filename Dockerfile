...
# NEXT_PUBLIC_APP_LOCALE was removed deliberately. Being a NEXT_PUBLIC_*
# value it was inlined at build time, so it could never switch the UI
# language at runtime and only the English dictionary was ever bundled.
# See src/i18n/request.ts before adding a locale build arg back.
