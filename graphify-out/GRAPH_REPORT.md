...
## Corpus Check
- 125 files · ~85,413 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 454 nodes · 560 edges · 16 communities detected
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 125 edges (avg confidence: 0.8)
...
Cohesion: 0.06
Nodes (24): fetchTemplates(), fetchMissing(), fetchTags(), calculateReach(), DELETE(), GET(), POST(), ImportModal() (+16 more)
...
Cohesion: 0.17
Nodes (19): normalizeCategory(), normalizeStatus(), POST(), findOrCreateContact(), findOrCreateConversation(), flagBroadcastReplyIfAny(), GET(), handleStatusUpdate() (+11 more)
...
- **Why does `createClient()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 11`, `Community 14`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `supabaseAdmin()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `POST()` connect `Community 3` to `Community 0`, `Community 4`?**
